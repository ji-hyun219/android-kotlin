...
import com.example.mytestapp.databinding.ActivityGoodWordsBinding
...
class GoodWordsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.e("GoodWordsActivity", sentenceList.toString())

        binding = DataBindingUtil.setContentView(this, R.layout.activity_good_words)
